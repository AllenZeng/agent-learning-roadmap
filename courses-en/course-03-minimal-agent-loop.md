...
| Agent | An instance of a running application |**Prompt is not a note you wrote to LLM by hand -- it's a program you wrote in natural language.** Like other procedures, it needs to be designed, tested and iterative.
...
| `search_text` | Keywords, collection of texts | Match Snippet | Find information in information |**Tool returns must be structured**. This follows from the philosophy of Design Calling:
