...
> **课程定位**：本课程是Agent学习路径的收官阶段。前五门课程你已经掌握了理论基础、工具使用、框架原理和评估方法，现在需要将这些能力转化为实际可展示的作品。本课程包含三个难度递进的项目，从入门级的知识助手到中级的代码审查Agent，再到高级的垂直领域产品。每个项目都可以独立成为一个完整的作品集案例。
...
- 已完成课程一到课程五的系统学习
- 有一个经过多轮迭代的 Agent 项目基础（可以基于课程三/四的项目继续开发）
...
4. 一份评测报告（用课程四学的评测框架，对最终版本做一次完整评测）
