...
3. 将阶段一到阶段五学到的所有能力（Tool Use、编排、记忆、评测、护栏、交互、可靠性、成本控制）整合到一个项目中
4. 建立自己的 Agent 开发方法论和代码库

### 📥 前置输入

- 已完成阶段一到阶段五的系统学习
- 有一个经过多轮迭代的 Agent 项目基础（可以基于阶段三/四的项目继续开发）
...
1. **个人知识助手 Agent**（入门）：适合刚学完阶段三、想巩固基础的学员
...
4. 一份评测报告（用阶段四学的评测框架，对最终版本做一次完整评测）
...
2. **工具使用**（阶段三）：熟练使用主流Agent框架和工具
3. **框架原理**（阶段四）：能够深入框架内部，理解设计决策
4. **评估体系**（阶段五）：知道如何衡量Agent的质量
5. **高级主题**（阶段七）：掌握了多Agent协作、安全等进阶话题
