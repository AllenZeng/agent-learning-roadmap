# 课程六：Agent 项目实战 —— 从学到到做到

## 课程导言

本课程是 Agent 学习路径的收官阶段。前五门课程你已经掌握了理论基础、工具使用、框架原理和产品化方法，现在需要将这些能力转化为实际可展示的作品。三个项目遵循"爬-走-跑"的节奏：项目一（个人知识助手）跑通第一个完整的 Agent 循环；项目二（代码审查）引入外部服务集成和领域知识注入；项目三（领域产品）由你结合自己的领域知识，做出真正属于自己的产品。
...
3. 将课程一到课程五学到的所有能力（Tool Use、编排、记忆、评测、护栏、交互、可靠性、成本控制）整合到一个项目中
4. 建立自己的 Agent 开发方法论和代码库

## 目录

- [学习方法说明](#学习方法说明)
- [第一章：个人知识助手Agent](#第一章个人知识助手agent)
- [第二章：代码审查Agent](#第二章代码审查agent)
- [第三章：领域Agent产品](#第三章领域agent产品)
- [第四章：通用方法论](#第四章通用方法论)
...
很多人学习技术的方式是"看懂了就以为自己会了"。他们读完文档、看完教程、理解了概念，就跳到下一个主题。但事实是：**只有你真正搭建出来的东西，才是你掌握的**。
...
> **难度等级**：入门 | **达标目标**：至少达到"合格版"，鼓励冲击"进阶版"
...
> **难度等级**：中级 | **达标目标**：至少达到"合格版"，鼓励冲击"进阶版"
...
> **难度等级**：高级 | **达标目标**：至少达到"合格版"，根据投入时间冲击"进阶版"或"产品版"
...
- **你可以建立对复杂度的直觉**：只有真正做过，你才知道哪些部分是最容易出问题的，哪些是相对简单的
...
1. **理论基础**（课程一）：理解了LLM的工作原理、Agent的基本概念
2. **工具使用**（课程三）：熟练使用主流Agent框架和工具
3. **框架原理**（课程四）：能够深入框架内部，理解设计决策
4. **评估体系**（课程五）：知道如何衡量Agent的质量
5. **高级主题**（课程七）：掌握了多Agent协作、安全等进阶话题
6. **实践能力**（课程六）：能够独立设计、实现和部署Agent产品
...
1. **个人知识助手 Agent**（入门）：适合刚学完课程三、想巩固基础的学员
