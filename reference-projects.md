...
| 项目 | Stars | 为什么要看 |
|------|-------|----------|
| [AutoGPT](https://github.com/Significant-Gravitas/AutoGPT) | ~170k | Agent 概念的"破圈者"，读它的架构演进能理解这个领域怎么走到今天的 |
| [GPT-Researcher](https://github.com/assafelovic/gpt-researcher) | ~25k | 非常适合拆解学习的 Agent 产品——规划→搜索→综合→输出的流程很清晰 |
