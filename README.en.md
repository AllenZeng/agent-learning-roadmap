...
> Current status: The English version is available through course 05-09, with course 06-08 still in progress.
...
Start with the [syllabus](syllabus.en.md). It gives you the full map of the course, explains the learning layers, and helps you choose where to begin.
...
syllabus.md            # Simplified Chinese syllabus
syllabus.en.md         # English syllabus
...
The default GitHub entry is Simplified Chinese. English readers can use the full [English README](README.en.md).
